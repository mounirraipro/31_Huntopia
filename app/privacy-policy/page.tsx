...
export const metadata: Metadata = {
    ...
    description: 'Read the Huntopia Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Huntopia privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Huntopia, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Huntopia, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Huntopia is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@huntopia.online</strong>.
                </p>
            </div>
        </>
    );
