...
export const metadata: Metadata = {
    ...
    description: 'Huntopia is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Huntopia accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Huntopia accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Huntopia is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Huntopia presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Huntopia. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@huntopia.online</strong></li>
                </ul>
                <p>
