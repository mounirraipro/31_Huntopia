...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Huntopia disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Huntopia disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Huntopia (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on huntopia.online
                ...
                <p>
                    Huntopia is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Huntopia displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Huntopia.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Huntopia is not responsible for any errors
