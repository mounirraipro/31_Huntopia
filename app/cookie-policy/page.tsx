...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Huntopia uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Huntopia cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Huntopia uses them, and how you can
                ...
                <p>Huntopia uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Huntopia.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@huntopia.online</strong>.
                </p>
            </div>
        </>
    );
