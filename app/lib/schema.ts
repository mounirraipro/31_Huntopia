...
const SITE_URL = 'https://huntopia.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Huntopia',
        url: SITE_URL,
        description: 'Play Huntopia free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Huntopia online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
