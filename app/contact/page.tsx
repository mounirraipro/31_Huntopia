...
const SUPPORT_EMAIL = 'hello@huntopia.online';

export const metadata: Metadata = {
    title: 'Contact Huntopia',
    description: 'Get in touch with the Huntopia team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Huntopia', 'Huntopia support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
