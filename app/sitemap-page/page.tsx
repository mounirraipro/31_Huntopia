...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Huntopia. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Huntopia sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Huntopia?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Huntopia.</p>
                </div>
            </div>
