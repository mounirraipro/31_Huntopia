...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Huntopia',
        url: 'https://huntopia.online/about',
        description: 'Learn about Huntopia, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Huntopia',
            url: 'https://huntopia.online',
        },
    },
    {
        '@context': 'https://schema.org',
...
export const metadata: Metadata = {
    title: 'About Us – Huntopia',
    description: 'Learn about Huntopia, our mission, and the team behind the game.',
    keywords: ['about Huntopia', 'game team', 'who made Huntopia'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Huntopia</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Huntopia was born from a simple idea: what if playing Huntopia could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Huntopia with a clear vision — to create a free, accessible, and
                    ...
                    Huntopia has something for you.
                </p>
                ...
                <p>
                    Every level in Huntopia is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Huntopia offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Huntopia better for
                    everyone.
                </p>
            </div>
        </>
